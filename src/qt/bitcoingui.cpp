...
{
    resize(850+95, 550);
    setWindowTitle(tr("BlackCoinLite") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a BlackCoinLite address"));
    ...
    exchangeAction = new QAction(QIcon(":/icons/trade"), tr("Tr$ade"), this);
    exchangeAction->setToolTip(tr("Trade BlackCoinLite at Yobit exchange"));
    ...
    aboutAction = new QAction(tr("&About BlackCoinLite"), this);
    aboutAction->setToolTip(tr("Show information about BlackCoinLite"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for BlackCoinLite"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("BlackCoinLite client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("BlackCoinLite client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BlackCoinLite network", "", count));
}
...
{
    QString strTitle = tr("BlackCoinLite") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid BlackCoinLite address or malformed URI parameters."));
    }
