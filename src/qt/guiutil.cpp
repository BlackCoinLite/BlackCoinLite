...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(uri.scheme() != QString("blackcoinlite"))
        return false;
...
{
    // Convert blackcoinlite:// to blackcoinlite:
    //
    //    Cannot handle this later, because bitcoin:// will cause Qt to see the part after // as host,
    //    which will lower-case it (and thus invalidate the address).
    if(uri.startsWith("blackcoinlite://"))
    {
        uri.replace(0, 12, "blackcoinlite:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "BlackCoinLite.lnk";
}
...
{
    return GetAutostartDir() / "blackcoinlite.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("BlackCoinLite-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  blackcoinlite-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    setWindowTitle(tr("BlackCoinLite-Qt"));
...
void SetBlackThemeQSS(QApplication& app)
{
    app.setStyleSheet("QWidget        { background: rgb(41,44,48); }"
                      ...
                      "QPushButton    { border: 1px solid #C0C0C0; padding: 4px; background: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #C0C0C0, stop: 0.5 #C0C0C0, stop: 0.51 #919191, stop: 0.54 #919191, stop: 1.0 #919191); color: rgb(21,21,21); }"
                      ...
                      "QMenuBar       { background: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #C0C0C0, stop: 0.5 #C0C0C0, stop: 0.51 #919191, stop: 0.54 #919191, stop: 1.0 #919191); color: rgb(110,116,126); }"
                      "QMenuBar:item  { background: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #C0C0C0, stop: 0.5 #C0C0C0, stop: 0.51 #919191, stop: 0.54 #919191, stop: 1.0 #919191); color: #000000; }"					  
                      "QMenu          { background: #C0C0C0; color: #000000; }"
                      "QMenu::item:selected { background-color: #919191; }"
                      "QLabel         { color: #C0C0C0; }"
                      "QScrollBar     { color: rgb(255,255,255); }"
                      "QCheckBox      { color: #C0C0C0; }"
                      "QRadioButton   { color: #C0C0C0; }"
                      "QTabBar::tab   { color: #C0C0C0; border: 1px solid rgb(78,79,83); border-bottom: none; padding: 5px; }"
                      ...
                      "QToolButton:checked { color: rgb(255,255,255); border: none; border-left-color: #C0C0C0; border-left-style: solid; border-left-width: 6px; }"
